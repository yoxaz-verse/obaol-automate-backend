...
InquirySchema.index({ supplierOperatorId: 1, updatedAt: -1, createdAt: -1 });
InquirySchema.index({ dealCloserOperatorId: 1, updatedAt: -1, createdAt: -1 });
InquirySchema.index({ createdBy: 1, updatedAt: -1, createdAt: -1 });
