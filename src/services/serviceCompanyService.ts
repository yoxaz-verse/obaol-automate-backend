...
import ServiceCompanyRepository from "../database/repositories/serviceCompanyRepository";
...
class ServiceCompanyService {
  ...
  public async getServiceCompanies(req: Request, res: Response) {
    try {
      const serviceCompanies = await this.serviceCompanyRepository.getServiceCompanies(req);
  ...
  public async updateServiceCompany(req: Request, res: Response) {
    try {
      const { id } = req.params;
      const serviceCompanyData = req.body;
      const updatedServiceCompany = await this.serviceCompanyRepository.updateServiceCompany(req, id, serviceCompanyData);
